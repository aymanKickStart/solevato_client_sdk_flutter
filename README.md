...
## 3. How to use
Replace `baseUrl` and `inboxIdentifier` with appropriate values from your dashboard
...
SolevatoChatDialog.show(
  context,
  baseUrl: "<<<your-solevato-base-url-here>>>",
...
| baseUrl           | -                         | String       | Installation url for solevato                                                                                                                                                                                                                                                                                                                                                                                                                       |
