...
part 'solevato_message.g.dart';

/// {@category FlutterClientSdk}
@JsonSerializable(explicitToJson: true)
@HiveType(typeId: SOLEVATO_MESSAGE_HIVE_TYPE_ID)
class SolevatoMessage extends Equatable {
  ...
  factory SolevatoMessage.fromJson(Map<String, dynamic> json) =>
      _$SolevatoMessageFromJson(json);

  Map<String, dynamic> toJson() => _$SolevatoMessageToJson(this);
