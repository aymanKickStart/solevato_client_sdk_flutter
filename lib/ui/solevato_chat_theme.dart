...
const SOLEVATO_COLOR_PRIMARY = Color(0xff1f93ff);
const SOLEVATO_BG_COLOR = Color(0xfff4f6fb);
const SOLEVATO_AVATAR_COLORS = [SOLEVATO_COLOR_PRIMARY];

/// Default solevato chat theme which extends [ChatTheme]
@immutable
class SolevatoChatTheme extends ChatTheme {
  /// Creates a solevato chat theme. Use this constructor if you want to
  /// override only a couple of variables.
  const SolevatoChatTheme({
    Widget? attachmentButtonIcon,
    Color backgroundColor = SOLEVATO_BG_COLOR,
    ...
    Color primaryColor = SOLEVATO_COLOR_PRIMARY,
    ...
    List<Color> userAvatarNameColors = SOLEVATO_AVATAR_COLORS,
