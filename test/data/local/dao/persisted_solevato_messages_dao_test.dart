...
void main() {
  group("Persisted Solevato Message Dao Tests", () {
    late PersistedSolevatoMessagesDao dao;
    late Box<String> mockClientInstanceKeyToMessageBox;
    late Box<SolevatoMessage> mockMessageBox;
    ...
    setUp(() {
      return Future(() async {
        mockMessageBox =
            await Hive.openBox(SolevatoMessagesBoxNames.MESSAGES.toString());
        mockClientInstanceKeyToMessageBox = await Hive.openBox(
            SolevatoMessagesBoxNames.MESSAGES_TO_CLIENT_INSTANCE_KEY
                .toString());

        dao = PersistedSolevatoMessagesDao(mockMessageBox,
