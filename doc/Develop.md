...
Clone the [solevato-flutter-sdk](https://bitbucket.com/solevato/solevato-flutter-sdk) repository.

```bash
git clone git@bitbucket.com:solevato/solevato-flutter-sdk.git
```
...
```
cd <path-to>/solevato-flutter-sdk/example
```
...
After the above steps, you can follow [how to use steps](https://bitbucket.com/solevato/solevato-flutter-sdk#3-how-to-use).
...
```
cd user/solevato-flutter-sdk/example/ios
```
